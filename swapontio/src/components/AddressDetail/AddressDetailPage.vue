      ...
      <table class="table table-hover">
        ...
        <tr >
          <td class="td11">
            ...
            <p class="table1_item_title font-size24 font-Regular normal_color" v-for="asset in AssetBalance">{{asset.AssetName=='ont'?"ONT":asset.AssetName=='ong'?"ONG":"ONG_APPROVE"}}: <span class="important_color">{{asset.Balance}}</span></p>
          </td>
        </tr>
        </tbody>
      </table>
