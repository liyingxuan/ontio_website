...
<!--                             <p class="p-font text2 val-img" style="text-align:left">
                        ...
                        <div v-for="(item,index) in article.Detail" class="col-sm-12" style="padding:0px;margin-bottom:32px;">
                            ...
                            <div v-if="item.h2" class="col-sm-12" style="padding:0px;">
                                <div class="col-sm-2"></div>
                                <div  class="col-sm-8 " >
                                    <p class="head2 head3-color-news" style="text-align:left">
                                        {{item.h2}}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12" style="padding:0px;">
                            <div class="col-sm-2"></div>
                            <div  class="col-sm-8 " >
                                <a @click="toontview()" v-if="returnlanguage" class="link" style="background: #F6F6F6;padding: 8px 32px;">
                                  返回新闻目录
                                </a>
                                <a @click="toontview()" v-else class="link" style="background: #F6F6F6;padding: 8px 32px;">
                                  return
                                </a>
                            </div>
                        </div>
...
/*       'NewsFileEN':function(){
    ...
    methods: {
        toontview:function(){
            this.$router.push({'path': '/ont-view/'+this.$route.params.lang})
        },
